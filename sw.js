/* L'Ultima Veglia — service worker v3
   Differenza rispetto alla v2: per la pagina si prova PRIMA la rete.
   Così un aggiornamento caricato su GitHub si vede al primo avvio con
   connessione, senza dover toccare nulla. La cache resta come riserva
   per l'uso offline. */
const CACHE='ultima-veglia-v3';
